...
* Open the project in your terminal alongside `corpus`
  * if you're using git-bash, you can type `questions.py corpus`
* Type your question in the query section when prompted
```
